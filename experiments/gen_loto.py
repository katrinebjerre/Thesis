...
def main():
    ...
    SETTINGS = {
        **get_base_settings(),
        ...
        "results_file": "gen_loto.csv",
        "history_file": "gen_loto_history.csv",
    }
    ...
    for target in targets:
        print(f"Running gen_loto | held_out_target={target}")
