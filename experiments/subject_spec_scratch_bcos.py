# experiments/subject_spec_scratch_bcos.py
...
def main():
    ...
    SETTINGS = {
        **get_base_settings(),
        ...
        "results_file": "subject_spec_scratch_bcos.csv",
        "history_file": "subject_spec_scratch_bcos_history.csv",
    }
    ...
    for subject in subjects:
        for target in targets:
            print(f"Running subject_spec_scratch_bcos | subject={subject} | held_out_target={target}")

            subject_str = str(subject).zfill(3)

            # Create model name
            model_name = f"subject_spec_scratch_bcos_{subject_str}_{target}"
            ...
            # Metadata for CSV
            row_info = {
                "experiment_type": "subject_spec_scratch_bcos",
    ...
    print("Finished subject_spec_scratch_bcos")
